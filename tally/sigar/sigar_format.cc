...
char *sigar_strerror_get(int err, char *errbuf, int buflen)
{
    ...
    if (strerror_r(err, errbuf, buflen) == nullptr) {
        buf = "Unknown Error";
    }
#else
                                               ...
                                               char *addr_str)
{
    *addr_str = '\0';
    switch (address->family) {
      ...
      case SigarNetAddress::SIGAR_AF_UNSPEC:
...
SIGAR_DECLARE(const char *)sigar_net_connection_type_get(SigarNetConnType type)
{
    switch (type) {
        case SigarNetConnType::SIGAR_NETCONN_TCP:
        return "tcp";
        case SigarNetConnType::SIGAR_NETCONN_UDP:
        return "udp";
        case SigarNetConnType::SIGAR_NETCONN_RAW:
        return "raw";
        case SigarNetConnType::SIGAR_NETCONN_UNIX:
        return "unix";
      default:
        return "unknown";
    }
