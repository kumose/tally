...
#include <tally/sigar/sigar_log.h>
...
#define sigar_net_interface_ipv6_config_init(ifconfig) \
    ifconfig->address6.family = SigarNetAddress::SIGAR_AF_INET6; \
...
#define SIGAR_PROC_ENV_KEY_LOOKUP() \
    if ((procenv->type == sigar_proc_env_t::SIGAR_PROC_ENV_KEY) && \
        (pid == sigar->pid)) \
    { \
